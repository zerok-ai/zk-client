...
helm --install --set=deployKey=$PX_API_KEY --set=clusterName=$PX_CLUSTER_NAME  upgrade pixie https://pixie-operator-charts.storage.googleapis.com/pixie-operator-chart  --namespace pl --create-namespace
